                ...
                <div className="w-[170px]">
                  <div className="relative">
                    <button
                      ...
                      className="flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg bg-dark-fill-3 hover:bg-dark-fill-2  w-full justify-between"
                      type="button"
                    >
                      {fontSize}
                      <BsChevronDown />
